...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "null,225xxxxxxxxxx";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "false"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "null,225xxxxxxxxxx";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2250799684818,923xxxxxxxxxx";
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "♱𝛭𝑅.𝑅𝛩𝑌𝛥𝐿♱",
